                    ...
                    <div class="swiper-container" data-effect="fade">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="product-details-img-wrap ">
                                <img src="{{ asset($product->image) }}" width="350px" height="250px" alt="{{$product->name}}" data-swiper-parallax="-10">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    ...
                    <form action="{{ route('cart.add') }}" method="post">
                        ...
                        <input title="Qty" class="email input-text qty text" name="qty" type="text" value="1" placeholder="1">
